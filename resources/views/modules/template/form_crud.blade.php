...
<div class="row p-2">
    ...
    <div class="input-group mb-3 col-md-6 col-sm-12">
        ...
        <input type="text" name="title_template" value="{{ old('title', $template->title)}}" class="form-control" placeholder="Titulo del Documento" aria-label="title_contract" aria-describedby="basic-addon1" />
    </div>
    ...
    <div class="input-group mb-3 col-md-8 col-sm-12">
        ...
        <input type="text" name="description_template" value="{{ old('description', $template->description )}}" class="form-control" placeholder="Descripcion del documento" aria-label="description_contract" aria-describedby="basic-addon1" />
    </div>
</div>
